    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="请求头：">{{ form.reqAgent }}</el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="浏览器：">{{ form.reqBrowser }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="操作系统：">{{ form.reqSystem }}</el-form-item>
          </el-col>
