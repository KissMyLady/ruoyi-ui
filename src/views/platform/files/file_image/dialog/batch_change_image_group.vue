...
import { file_batchChangeImageGroup } from '@/api/platform/files/file_batch_change'
...
export default {
  ...
  methods: {
    ...
    addButtonClick() {
      ...
      file_batchChangeImageGroup(sendData).then((res) => {
        if (res.code !== 200) {
    ...
    get_group_list() {
      ...
      listFile_image_group(sendData).then(response => {
