  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
      ...
      <el-form-item label="封面图" prop="indexImgStatic">
        <el-input
            v-model="queryParams.indexImgStatic"
            placeholder="请输入封面图"
            clearable
            @change="handleQuery"
            @keyup.enter.native="handleQuery"
    ...
    >
      ...
      <el-table-column align="center" width="auto" label="关联类别" prop="forIdealCategoryId"/>
      ...
      <el-table-column label="当前是否允许评论" align="center" prop="allowComment">
        <template slot-scope="scope">
